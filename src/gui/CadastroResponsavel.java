...
public class CadastroResponsavel extends JFrame {
	...
	public CadastroResponsavel() {
		...
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // fecha somente a janela solicitada (oposto de
															// EXIT_ON_CLOSE)
		...
		parentesco.setModel(new DefaultComboBoxModel(
				new String[] { "Pai", "Mãe", "Avó", "Avô", "Tio", "Tia", "Padrinho", "Madrinha" }));
		parentesco.setMaximumRowCount(6);
		...
		btnCadastrar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				Responsavel responsavel = new Responsavel(vNome, vCpf, vRg, vTelefone, vDataNasc, vendereco,
						vparentesco);
